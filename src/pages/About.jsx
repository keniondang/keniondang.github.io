...
const pillars = [
  {
    icon: <Search size={22} />,
    title: "Research",
    desc: "Market, product, and user research that turns questions about a market into evidence a team can act on."
  },
  {
  ...
  return (
    <div className="min-h-screen pt-20 px-6 md:px-20 max-w-6xl mx-auto pb-24">
      ...
      <motion.section
        ...
        viewport={{ once: true }}
        className="mb-24 grid md:grid-cols-3 gap-10"
      >
        <div className="md:col-span-1">
          <div className="md:sticky md:top-24">
            <h2 className="text-2xl font-bold text-slate-100 mb-3">My Story</h2>
            <div className="h-1 w-12 bg-blue-500 rounded-full shadow-[0_0_15px_#3b82f6]" />
          </div>
        </div>
        ...
        <div className="md:col-span-2 space-y-6">
          ...
          {/* Pull-quote: the line that captures who you are */}
          <blockquote className="relative pl-6 py-1 border-l-2 border-blue-500/60">
            <span className="text-xl md:text-2xl font-semibold text-slate-100 leading-snug">
              I like understanding the people behind the numbers, not just the numbers themselves.
            </span>
          </blockquote>
